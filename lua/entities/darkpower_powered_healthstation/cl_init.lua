...
function ENT:DrawPrinterHUD()
	...
	cam.Start3D2D(self:GetPos(), final_angle, 0.075)
		...
		draw.SimpleTextOutlined("Money", "Power3", x_offset * multiplier, (-15 + y_offset) * multiplier, Color(255,255,255,alphacalc),0,0, math.Clamp(2*mathmemes, -1, 2), Color(0,0,0,125*mathmemes))
		draw.SimpleTextOutlined("$" .. money, "Power", x_offset * multiplier, (5 + y_offset) * multiplier, Color(255,255,255,alphacalc),0,0, math.Clamp(2*mathmemes, -1, 2), Color(0,0,0,125*mathmemes))
